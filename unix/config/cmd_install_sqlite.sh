...
#================================================
GLIB_LINK=https://www.sqlite.org/2019/sqlite-autoconf-3290000.tar.gz
GLIB_ARCHIVE_NAME=sqlite-autoconf-3290000.tar.gz
GLIB_ARCHIVE_SRC=sqlite-autoconf-3290000
...
GLib_Download() {
    ...
    if [ ! -d $GLIB_ARCHIVE_SRC ] ; then tar xzfv $GLIB_ARCHIVE_NAME ; fi
    cd $GLIB_SCRIPT_ROOT
}
#================================================
GLib_Build() {
